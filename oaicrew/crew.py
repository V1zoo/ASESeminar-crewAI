...
from oaicrew.tools.custom_tool import MyCustomTool
...
class Oaicrew():
    ...
    def coder(self) -> Agent:
        return Agent(
            ...
            verbose=True,
            tools=[MyCustomTool(), FileWriterTool(), FileReadTool()]
        )
    ...
    @task
    def bugfix_task(self) -> Task:
        return Task(
            config=self.tasks_config['bugfix_task'], # type: ignore[index]
